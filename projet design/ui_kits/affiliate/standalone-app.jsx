  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <img src={window.__resources.logo} alt="" style={{ width: 24, height: 24 }}/>
      </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img src={window.__resources.logo} alt="" style={{ width: 22, height: 22 }}/>
        </div>
        ...
        <div className="aff-footer-grid" style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr 1fr", gap: 32, alignItems: "start" }}>
          <div>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 10 }}>
              <img src={window.__resources.logo} alt="" style={{ width: 28, height: 28, borderRadius: 8 }}/>
