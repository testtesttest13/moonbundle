        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/[0.06] bg-gradient-to-b from-navy-800/80 to-navy-900/90">
          ...
          <div className="relative z-10 flex flex-col items-center py-16 px-8 sm:py-24 sm:px-16">
            ...
            >
              ...
              <span>1 200+ stores actifs</span>
              <span className="hidden h-3 w-px bg-white/10 sm:block" />
              <span className="text-green-400">Built for Shopify</span>
            </motion.div>
            ...
            >
              Si quelqu&apos;un s&apos;abonne à Moonbundles grâce à toi, on te reverse{" "}
              <span className="text-white">40% chaque mois</span>. Automatiquement. Sans limite.
            </motion.p>
